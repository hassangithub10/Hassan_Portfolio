...
export const metadata = {
    title: "Admin Dashboard | Hassan Sarfraz",
};

export default async function AdminDashboard() {
    // Fetch counts - simple aggregation
    const [postsCount, projectsCount, servicesCount, messagesCount, realTimeTraffic, gscPerformance] = await Promise.all([
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                ...
                <GlassCard className="p-8 min-h-[300px]">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button className="p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors border border-white/10 text-left group">
