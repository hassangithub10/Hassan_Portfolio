            ...
            >
                <motion.div
                    className={clsx(
                        ...
                        "bg-white/40 backdrop-blur-xl border border-primary-500/10",
                ...
                >
                    ...
                    <button
                        ...
                        className="md:hidden relative z-20 w-10 h-10 flex items-center justify-center rounded-full bg-primary-500/10 text-primary-500 hover:bg-primary-500/20 transition-colors"
