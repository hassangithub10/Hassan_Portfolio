...
const defaultSocialLinks = [
    ...
    {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/hassan-s-101a8978",
        icon: (
    ...
    {
        name: "GitHub",
        url: "https://github.com/hassangithub10",
        icon: (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
        name: "Whatsapp",
        url: "https://api.whatsapp.com/send/?phone=%2B923117371750&text&type=phone_number&app_absent=0",
        icon: (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    return (
        <footer className="relative py-8 border-t border-primary-500/10">
            ...
            <div
                ...
                style={{
                    background: `radial-gradient(ellipse at 50% 100%, rgba(var(--color-primary), 0.05) 0%, transparent 70%)`,
                }}
            />
            ...
            <div className="container relative z-10">
                <div className="flex flex-row md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <p className="text-gray-700 text-sm text-center" suppressHydrationWarning>
                            {copyrightText}
                        </p>
                    </div>
                    ...
                    <nav aria-label="Social Links" className="flex items-center gap-4">
                        {defaultSocialLinks.map((social) => (
                            <motion.a
                                ...
                                className="w-10 h-10 rounded-xl bg-primary-500/5 flex items-center justify-center text-primary-500/60 hover:text-primary-500 hover:bg-primary-500/10 transition-all"
